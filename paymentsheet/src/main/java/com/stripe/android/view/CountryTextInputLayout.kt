...
internal class CountryTextInputLayout @JvmOverloads constructor(
    ...
    var selectedCountryCode: CountryCode? by Delegates.observable(
        ...
        newCountryValue?.let {
            ...
            com.stripe.android.paymentsheet.elements.country.CountryUtils.getCountryByCode(it, getLocale())?.let { country ->
                countryChangeCallback(country)
            }
        }
    }

    val selectedCountry: com.stripe.android.paymentsheet.elements.country.Country?
